...
📄 *Ver diagrama completo en [`Clases.puml`](./backend/docs/uml/diagramaClases.pdf) elaboración propia*
...
📄 *Ver diagrama completo en [`diagramaNegocio.puml`](./backend/docs/uml/diagramaNegocio.pdf)  elaboración propia*
...
```
 📄 *Ver diagrama entidad-relacion en [`diagrama-er.puml`](./backend/docs/uml/diagrama-er.pdf)  elaboración propia*
